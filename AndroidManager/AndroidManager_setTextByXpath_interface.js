<div class="container-fluid">
	...
	<%= _.template($('#input_constructor').html())({
		...
		disable_int: true,
		value_string: "",
		help: {description: tr("The text to be entered.<br>Only English letters and numbers, Cyrillic is not supported.")}})
	%>
	<div data-preserve="true" data-preserve-type="check" data-preserve-id="clearText">
		<input type="checkbox" id="clearText" checked="checked"/>
		<label for="clearText" class="tr">Clear the field before entering text</label>
	</div>
	<div data-preserve="true" data-preserve-type="check" data-preserve-id="waitForElement">
...
<div class="tooltipinternal">
	<div class="tr tooltip-paragraph-first-fold">Input text to the field.</div>
</div>
