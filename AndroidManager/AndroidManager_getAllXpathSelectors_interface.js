<div class="container-fluid">
	...
	<%= _.template($('#variable_constructor').html())({
		...
		default_variable: "XML_LIST",
		help: {description: tr("If the elements are found, then the action will return the list of their XML, if not found - <code>false</code>.")}})
	%>
</div>
<div class="tooltipinternal">
	<div class="tr tooltip-paragraph-first-fold">Get an XML list of each element.</div>
</div>
