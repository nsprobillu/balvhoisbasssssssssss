<div class="container-fluid">
	...
	<%= _.template($('#variable_constructor').html())({
		...
		default_variable: "IS_APP_INSTALLED",
		help: {description: tr("<code>true</code> - application is installed;<br><code>false</code> - not installed.")}})
	%>
</div>
<div class="tooltipinternal">
	<div class="tr tooltip-paragraph-first-fold">Find out if an app is installed.</div>
</div>
