<div class="container-fluid">
	...
	<%= _.template($('#variable_constructor').html())({
		...
		default_variable: "XML",
		help: {description: tr("If the element is found, then the action will return its XML, if not found - <code>false</code>.")}})
	%>
</div>
<div class="tooltipinternal">
	<div class="tr tooltip-paragraph-first-fold">Get the XML of the element.</div>
</div>
