...
try{
  var code = loader.GetAdditionalData() + _.template($("#use_profile_code").html())({profile:Path["updated"], load_fp: LoadFPFromFolder["updated"], load_proxy: LoadProxyFromFolder["updated"], key: Key["updated"]});
